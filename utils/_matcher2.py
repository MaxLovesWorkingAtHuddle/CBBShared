...
MATCHED_FILE = os.path.join(BASE_DIR, "utils", "matched_games.json")
OO_FILE = os.path.join(BASE_DIR, "utils", "1parsedOO.json")
HOS_FILE = os.path.join(BASE_DIR, "utils", "1parsedHOS.json")
console = Console()
